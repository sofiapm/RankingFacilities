...
class MeasuresControllerTest < ActionController::TestCase
  ...
  test "should create measure" do
    assert_difference('Measure.count') do
      post :create, measure: { end_date: @measure.end_date, name: @measure.name, start_date: @measure.start_date, unit: @measure.unit, value: @measure.value }
    end
  ...
  test "should update measure" do
    patch :update, id: @measure, measure: { end_date: @measure.end_date, name: @measure.name, start_date: @measure.start_date, unit: @measure.unit, value: @measure.value }
    assert_redirected_to measure_path(assigns(:measure))
  end
